        ...
        if($estadia->getVehiculoPermitido() == $vehiculoPermitido){
            if($estadia->getHorario() != $horario){
                if($estadia->getPrecio() != $precio){
                    ...
                    header("location:panel?seccion=modificar&accion=editado");
                    die;                    
                }else{
                    header("location:panel?seccion=modificar&accion=ErrorNingunaModificacion");
                    die;
                }
            }else{
                header("location:panel?seccion=modificar&accion=ErrorHorarioRepetido");
                die;
            }
        }else{
            header("location:panel?seccion=modificar&accion=ErrorVehiculo");
        }
    }
}else{
